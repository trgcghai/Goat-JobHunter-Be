...
public class SalaryBenefitsAwardStrategyImpl implements AwardStrategy{
    private final ReviewRepository reviewRepository;

    @Override
    public RatingType getType() {
        return RatingType.SALARY;
    }

    @Override
    public List<CompanyAwardResult> calculate(int year) {
        return this.reviewRepository.findBestSalaryBenefitsCompany(year);
    }
}
