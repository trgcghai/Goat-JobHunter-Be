...
public class RequireReviewReasonIfAdminValidator implements ConstraintValidator<RequireReasonIfAdmin, ReviewIdsRequest> {
    private final UserService userService;

    public RequireReviewReasonIfAdminValidator(UserService userService) {
        this.userService = userService;
    }

    @Override
    public boolean isValid(ReviewIdsRequest request, ConstraintValidatorContext context) {
